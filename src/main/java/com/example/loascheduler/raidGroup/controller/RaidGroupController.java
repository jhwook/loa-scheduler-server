...
public class RaidGroupController {
    ...
    public void addRaidGroup(@RequestParam String day) {
        raidGroupService.addRaidGroup(day);
    }
    ...
    public void addCharacterToRaidGroup(@RequestParam Long raidGroupId, @RequestParam Long characterId) {
        raidGroupService.addCharacterToRaidGroup(raidGroupId, characterId);
    }

    // 레이드 캐릭터 삭제
    @DeleteMapping("/raid/character")
    public void deleteCharacterToRaidGroup(@RequestParam Long raidGroupId, @RequestParam Long characterId) {
        raidGroupService.deleteCharacterToRaidGroup(raidGroupId, characterId);
    }
